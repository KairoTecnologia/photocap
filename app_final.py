...
# Importa o gerenciador de banco de dados SQL Server
try:
    from db_manager import DatabaseManager
    db = DatabaseManager()
    print("✅ Gerenciador de banco de dados SQL Server carregado")
except ImportError as e:
    print(f"⚠️ Gerenciador de banco de dados não disponível: {e}")
    db = None
...
def index():
    ...
    recent_events = []
    if db:
        recent_events = db.get_all_events()[:6]
    ...
    <div class="row">
        <div class="col-12">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="/upload_photos" class="btn btn-warning">
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <h3 class="mb-3">Eventos Recentes</h3>
                    <div class="row">
    ...
    return get_base_html("PhotoCap - Início", content)
...
def dashboard():
    ...
    if db:
        user_events = db.get_all_events()[:10]  # Últimos 10 eventos
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <a href="/event/{event['EventId']}" class="btn btn-primary btn-sm">
                        <i class="fas fa-eye"></i> Ver Fotos
                    </a>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card bg-info text-white">
                        <div class="card-body text-center">
                            ...
                            <h4>{session.get('username', 'Usuário')}</h4>
...
def upload_photos():
    ...
    if request.method == 'POST':
        ...
        if not event_id:
            messages.append('Selecione um evento')
        elif not files or all(file.filename == '' for file in files):
            messages.append('Selecione pelo menos uma foto')
        else:
            if db:
                uploaded_count = 0
                for file in files:
                ...
                if uploaded_count > 0:
                    ...
                    return get_base_html("Upload - PhotoCap", get_upload_photos_content(db), messages)
                else:
                    messages.append('Erro ao enviar fotos. Tente novamente.')
            else:
                messages.append('Sistema de banco de dados não disponível')
    
    return get_base_html("Upload - PhotoCap", get_upload_photos_content(db), messages)

def get_upload_photos_content(db):
                ...
                <div class="card-body p-4">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Selecione uma ou mais fotos. Formatos: PNG, JPG, JPEG, GIF</div>
                        </div>
